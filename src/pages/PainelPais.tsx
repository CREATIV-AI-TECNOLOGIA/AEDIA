    ...
    <div className={`${bgColors[tipo]} border rounded-lg p-4 mb-3`}>
      <div className="flex items-start">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className="mt-1 text-sm text-muted-foreground">{mensagem}</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex items-center py-3 border-b border-border last:border-0">
      <div className="w-16 text-center">
        <div className="text-sm font-medium text-muted-foreground/60">{data.split(' ')[0]}</div>
        <div className="text-lg font-bold text-foreground">{data.split(' ')[1]}</div>
      </div>
...
export default function PainelPais() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="bg-card rounded-xl shadow-md p-6 mb-8 border-l-4 border-indigo-500">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">{nomeAluno}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                <h3 className="font-semibold text-foreground">Matemática</h3>
            ...
            <div className="border rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                <h3 className="font-semibold text-foreground">Português</h3>
            ...
            <div className="border rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                <h3 className="font-semibold text-foreground">Ciências</h3>
      ...
      <div className="bg-card rounded-xl shadow-md overflow-hidden">
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link to="/frequencia" className="flex flex-col items-center p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-green-600 mb-2">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
              </div>
              <span className="text-foreground/90 font-medium text-center">Frequência</span>
            </Link>
            
            <Link to="/notas" className="flex flex-col items-center p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 mb-2">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z" />
                </svg>
              </div>
              <span className="text-foreground/90 font-medium text-center">Notas</span>
            </Link>
            
            <Link to="/calendario" className="flex flex-col items-center p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <span className="text-foreground/90 font-medium text-center">Calendário</span>
            </Link>
            
            <Link to="/diagnostico" className="flex flex-col items-center p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <span className="text-foreground/90 font-medium text-center">Diagnóstico</span>
            </Link>
          </div>
        </div>
      </div>
