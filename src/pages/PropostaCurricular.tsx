    ...
    <div className="p-6 bg-gradient-to-br from-slate-50 via-gray-50 to-blue-100">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Proposta Curricular</h1>
        </div>
        ...
        {/* Abas de navegação */}
        <div className="bg-white rounded-xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.1)] border border-gray-100 p-6 mb-6 hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.1)] transition-shadow duration-300">
        ...
        <div className="bg-blue-50 rounded-xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.1)] border border-blue-200 p-6 hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.1)] transition-shadow duration-300">
