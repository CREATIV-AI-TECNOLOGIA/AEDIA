...
import { Paperclip, X, Mic, MicOff, Globe, BrainCog, FolderCode, Settings, Send, Loader2 } from "lucide-react";
...
if (typeof document !== "undefined" && !document.getElementById("prompt-input-box-styles")) {
      ...
      <TooltipProvider>
        ...
        >
          <div
            ref={ref}
            className={cn(
              "rounded-3xl border border-[#444444] bg-[#1F2023] p-2 shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all duration-300 w-full max-w-[600px] min-w-[320px]",
...
const PromptInputTextarea = React.forwardRef<HTMLTextAreaElement, PromptInputTextareaProps & React.ComponentProps<typeof Textarea>>(
  ({
    ...
    const assignRef = React.useCallback((node: HTMLTextAreaElement | null) => {
    ...
    return (
      <Textarea
        ...
        className={cn("text-base text-white placeholder:text-gray-400", className)}
        disabled={disabled}
...
export const PromptInputBox = React.forwardRef<HTMLDivElement, PromptInputBoxProps>((props, ref) => {
  ...
  const [isRecording, setIsRecording] = React.useState(isListening);
  ...
  const handleSubmit = () => {
    ...
    let messagePrefix = "";
    if (webSearchEnabled) messagePrefix = "[Search: ";
    else if (showThink) messagePrefix = "[Think: ";
    else if (showCanvas) messagePrefix = "[Canvas: ";

    const baseMessage = trimmed || inputValue;
    const formattedInput = messagePrefix ? `${messagePrefix}${baseMessage}]` : baseMessage;
        ...
        <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2">
          ...
          >
            {inputValue.trim().length > 0 && (
              <PromptInputAction tooltip="Limpar texto">
                <button
                  onClick={() => {
                    setInputValue("");
                    setFiles([]);
            ...
            <PromptInputAction tooltip="Configurações">
              <button
              ...
              >
                <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                  <motion.div
                    ...
                    whileHover={{ rotate: webSearchEnabled ? 360 : 15, scale: 1.1, transition: { type: "spring", stiffness: 300, damping: 10 } }}
                    transition={{ type: "spring", stiffness: 260, damping: 25 }}
                  >
                    <Globe className={cn("w-4 h-4", webSearchEnabled ? "text-[#1EAEDB]" : "text-inherit")} />
                  </motion.div>
                </div>
                <AnimatePresence>
                  {webSearchEnabled && (
            ...
            <Button
              ...
              className={cn(
                ...
                isRecording
                  ...
                  : hasContent
                  ? "bg-white hover:bg-white/80 text-black shadow-md hover:shadow-lg"
